  ...
  return (
    <section>
      <section className="sm:px-14 sm:pt-6">
        <h1 className="mb-2 text-2xl font-medium tracking-tighter">Work</h1>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          />
          <WorkCard
            title="OpenRouter Refine"
            description="Refine with your own OpenRouter API key."
            image={refineImg}
            link="/work/openrouter-refine"
          />
          <WorkCard
            title="Transcribe"
