        ...
        <div className="flex flex-col min-h-0 mt-2 md:mt-0">
          ...
          {isEditMode ? (
            <textarea
              ...
              className="md:flex-1 w-full h-[300px] md:h-auto md:min-h-0 resize-none rounded-lg border border-neutral-200 bg-neutral-50 p-4 text-sm focus:border-neutral-400 focus:outline-none dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-100 font-mono"
              placeholder="Transcription will appear here..."
            />
          ) : (
            <div
              ref={outputRef}
              className="md:flex-1 w-full h-[300px] md:h-auto md:min-h-0 overflow-auto rounded-lg border border-neutral-200 bg-neutral-50 p-4 text-sm dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-100 font-mono"
            >
              {result ? (
